...
SELECT CANDIDATE.CANDIDATE_CODE, CANDIDATE.CANDIDATE_FNAME, CANDIDATE.CANDIDATE_LNAME, JOB_OPENING.JOB_OPENING_DESCRIPTION,
Q1.QUALIFICATION_DESCRIPTION AS CURRENT_QUALIFICATION, Q2.QUALIFICATION_DESCRIPTION AS REQUIRED_QUALIFICATION,
...
WHERE ENROLLMENT.ENROLLMENT_FEE_PAYMENT < SESSION.SESSION_FEE AND ENROLLMENT.ENROLLMENT_DATE >= '2025-01-01' AND ENROLLMENT.ENROLLMENT_DATE <= '2025-03-31';
